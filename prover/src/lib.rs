...
type NoFieldExtension<A> = <A as Air>::BaseField;
type QuadFieldExtension<A> = <<A as Air>::BaseField as StarkField>::QuadExtension;
    ...
    match options.field_extension() {
        FieldExtension::None => match options.hash_fn() {
            HashFunction::Blake3_256 => generate_proof::
                <AIR, TB, NoFieldExtension<AIR>, Blake3_256<AIR::BaseField>>(trace_builder, options),
            HashFunction::Blake3_192 => generate_proof::
                <AIR, TB, NoFieldExtension<AIR>, Blake3_192<AIR::BaseField>>(trace_builder, options),
            HashFunction::Sha3_256 => generate_proof::
                <AIR, TB, NoFieldExtension<AIR>, Sha3_256<AIR::BaseField>>(trace_builder, options),
        },
        FieldExtension::Quadratic => match options.hash_fn() {
            HashFunction::Blake3_256 => generate_proof::
                <AIR, TB, QuadFieldExtension<AIR>, Blake3_256<AIR::BaseField>>(trace_builder, options),
            HashFunction::Blake3_192 => generate_proof::
                <AIR, TB, QuadFieldExtension<AIR>, Blake3_192<AIR::BaseField>>(trace_builder, options),
            HashFunction::Sha3_256 => generate_proof::
                <AIR, TB, QuadFieldExtension<AIR>, Sha3_256<AIR::BaseField>>(trace_builder, options),
        },
    }
}
